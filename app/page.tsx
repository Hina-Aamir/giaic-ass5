...
export default function Home() {
  return (
    <div >
         <Header />
         <div className="flex">
         <div className="container bg-blue h-[calc(100vh-100px)] ,w-1/2 bg-white p-20 ">
          <h1 className="text-extrabold text-3xl">IMPECCABLE <br></br>CRAFTSMANSHIP AND <br></br>FINESSE
         </h1><br></br><br></br>
...
<div className="container bg-pink h-[calc(100vh-100px)] ,w-full bg-white p-10 ">
